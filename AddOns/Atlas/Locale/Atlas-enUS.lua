...
AtlasLVL = {
	...
	INTRO = {
			ZoneName = "Intro";
			Location = "Azeroth";
		_RED..INDENT..INDENT..INDENT.."       Welcome To The Ingame";
		_RED..INDENT..INDENT..INDENT.."        Joana's Leveling Guide";
		GREY.." ";
		GREY.." ";
		GREY.."Hello, I am Drbeefy";
		GREY.."I play on the Feenix Emerald Dream Server";
		BLUE.."I made this guide because I hated Alt Tabing";
		BLUE.."Every time I did anything";
		GREN.."Contact me in game".._RED.." Drbeefy"..GREN.." for any";
		GREN.."Questions, Donations , Flaws";
		GREN.."List of Bugged Quests or suggestions";
		GREN.."Please notify my via in game mail";
		ORNG.."I take no credit for the addon or guide itself";
		ORNG.."Only putting the two together";
		_RED..INDENT..INDENT..INDENT.."Coming Soon";
		BLUE..INDENT..INDENT.."Possible Waypoints";
		BLUE..INDENT..INDENT.."Emerald Dream Bugged quest Notes";
		BLUE..INDENT..INDENT.."Removal of non existing quests";
		_RED..INDENT..INDENT..INDENT.."Sponsored by the Tinydps fanclub";
	};	
